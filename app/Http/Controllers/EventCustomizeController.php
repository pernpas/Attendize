...
class EventCustomizeController extends MyBaseController
{
    ...
    public function postEditEventSocial(Request $request, $event_id)
    {
        ...
        $event->social_share_text = $request->get('social_share_text', 0);
        $event->social_show_facebook = $request->get('social_show_facebook', 0);
        $event->social_show_linkedin = $request->get('social_show_linkedin', 0);
        $event->social_show_twitter = $request->get('social_show_twitter', 0);
        $event->social_show_email = $request->get('social_show_email', 0);
        $event->social_show_googleplus = $request->get('social_show_googleplus', 0);
        $event->social_show_whatsapp = $request->get('social_show_whatsapp', 0);
        $event->save();
